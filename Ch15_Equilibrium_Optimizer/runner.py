...
def run_eo(dim=10, pop_size=50, max_iter=30):
    ...
    for func_class in func_classes:
        ...
        alg = EO(objective_func=obj_func, bounds=b, dim=dim, pop_size=pop_size, max_iter=max_iter)
        _, _ = alg.optimize()
