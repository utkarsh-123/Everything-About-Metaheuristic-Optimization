...
def run_ts(dim=10, max_iter=30):
    ...
    for func_class in func_classes:
        ...
        alg = TS(objective_func=obj_func, bounds=b, dim=dim, max_iter=max_iter)
        alg.optimize()
